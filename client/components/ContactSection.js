        ...
        <div className="mt-16 grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            ...
            <div className="flex space-x-4 pt-4">
              <a href={instagramLink} target="_blank" rel="noopener noreferrer" className="text-dark-text hover:text-accent transition-colors">
               ...
               <a href={linkedinLink} target="_blank" rel="noopener noreferrer" className="text-dark-text hover:text-accent transition-colors">
