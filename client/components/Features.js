...
const FeatureItem = ({ icon, text }) => (
  <li className="flex items-center space-x-3">
    <div className="flex-shrink-0">
      <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
    </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-lg text-dark-text mb-8 max-w-lg">
              We partner with educational institutions to provide scalable, effective career development solutions that prepare students for the future.
            </p>
          ...
          <div className="bg-secondary p-8 rounded-lg">
            <h3 className="text-2xl font-bold text-light-text mb-6">Our Core Strengths</h3>
