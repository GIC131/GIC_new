...
const CandidateDocsPage = () => {
    ...
    useEffect(() => {
        ...
        const fetchCandidateData = async () => {
            try {
                const res = await axios.get(`https://getinteviewconfidence.com/api/candidates/view/${key}`);
            ...
            <div className="container mx-auto px-6 max-w-2xl">
                ...
                <div className="space-y-4">
                    {candidate.documents.map(doc => (
                        <a key={doc._id} href={`https://getinteviewconfidence.com${doc.filePath}`} target="_blank" rel="noopener noreferrer" 
